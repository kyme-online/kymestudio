            ...
            <ul class="nav">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="active"><a href="print.php">Print Graphics</a></li>
    ...
    <div class="container container_cs">
      ...
      <div id="printcontainer">
            <div class="body-content">
                <h1>Print Graphics</h1>
                <p><?php echo $aboutme; ?> </p>
                <?php if (isset($_SESSION['username'])): ?><a href="securepage.php"><p class="edit">Edit</p><?php endif; ?>
